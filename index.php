...
<head>
  ...
  <title>Baixe A Miniatura Do Vídeo Do YouTube | Lucas Hilario Santos</title>
...
<body>
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
    ...
    <div class="url-input">
      <span class="title">Cole o url do vídeo:</span>
      <div class="field">
    ...
    <div class="preview-area">
      ...
      <span>Cole o url do vídeo para ver uma prévia</span>
    </div>
    <button class="download-btn" type="submit" name="button">Baixar miniatura</button>
  </form>
